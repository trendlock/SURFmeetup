...
sent.count.phrase <- read_rds("data/sent.parties.frac.rds")
...
sent.count.phrase <- read_rds("data/sent.banks.frac.rds")
...
sent.count.phrase <-read_rds("data/sent.workers.frac.rds")
